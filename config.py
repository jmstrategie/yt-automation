...
CHANNEL_B = ChannelConfig(
    ...
    niche               = "horror_fiction",
    topics              = [
        "creepy doll horror story", "haunted toy story",
        "evil doll possession", "cursed childhood toy",
        "horror story doll", "haunted house doll",
        "creepy doll comes alive", "possessed toy horror",
        "evil toy story", "doll horror fiction",
        "haunted doll mystery", "scary doll story",
    ],
    rss_feeds           = [
        "https://www.reddit.com/r/nosleep/.rss",
        "https://www.reddit.com/r/horror/.rss",
        "https://www.reddit.com/r/creepypasta/.rss",
    ],
    voice               = "en-US-GuyNeural",
    elevenlabs_voice_id = "mfxPGiKweaQEsXJix2Ve",
    thumbnail_style     = "horror_fiction",
